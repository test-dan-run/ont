...
from src.model.dual_transformer import DualTransformer
...
class DCUnet10_rTSTM(nn.Module):
    ...
    def __init__(self, n_fft, hop_length):
        ...
        # TSTM
        self.dual_transformer = DualTransformer(64, 64, nhead=4, num_layers=6)   # [b, 64, nframes, 8]
...
class DCUnet10_cTSTM(nn.Module):
    ...
    def __init__(self, n_fft, hop_length):
        ...
        # TSTM
        self.dual_transformer_real = DualTransformer(64, 64, nhead=4, num_layers=6)   # [b, 64, nframes, 8]
        self.dual_transformer_imag = DualTransformer(64, 64, nhead=4, num_layers=6)   # [b, 64, nframes, 8]
